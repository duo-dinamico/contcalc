...
class Notebook(ttk.Notebook):
    ...
    def create_general_tab(self, title):  
        ...
        """Labels for column 0"""
        CreateLabel(frame, text='Job Title: ', image='', background=None, height=6, width=0, row=2, column=0, colspan=1, sticky='W')
        CreateLabel(frame, text='Job Number: ', image='', background=None, height=6, width=0, row=3, column=0, colspan=1, sticky='W')
        CreateLabel(frame, text='Date: ', image='', background=None, height=6, width=0, row=4, column=0, colspan=1, sticky='W')
                
        CreateEntry(frame, text=self.sv_entry1, background='white', row=2, column=1, colspan=1, sticky='E')
        CreateEntry(frame, text=self.sv_entry2, background='white', row=3, column=1, colspan=1, sticky='E')
        CreateEntry(frame, text=self.sv_entry3, background='white', row=4, column=1, colspan=1, sticky='E')
        
        """Labels for column 2"""
        CreateLabel(frame, text='Designer: ', image='', background=None, height=6, width=0, row=3, column=2, colspan=1, sticky='W')
        CreateLabel(frame, text='Revision: ', image='', background=None, height=6, width=0, row=4, column=2, colspan=1, sticky='W')
        
        """Entries for column 3"""
        CreateEntry(frame, text=self.sv_entry4, background='white', row=3, column=3, colspan=1, sticky='E')
        CreateEntry(frame, text=self.sv_entry5, background='white', row=4, column=3, colspan=1, sticky='E')
